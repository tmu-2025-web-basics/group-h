...
function setupHamburgerMenu() {
    ...
    const submenuToggle = document.getElementById('playground-toggle');
    const submenu = document.getElementById('playground-submenu');
...
function initializeModal() {
    ...
    const playgroundPages = {
        ...
        '汽車': '../train/index.html',
        '鬼': '../oni/index.html',
        '大きな長靴': '../nagagutsu/index.html',
        '地球儀': '../earth/index.html',
        'ローラー滑り台': '../nagaisuberidai/index.html',
        '虹のハンモック': '../hammock/index.html',
        'ドラゴンスライダー': '../pyramid/index.html'
    };
